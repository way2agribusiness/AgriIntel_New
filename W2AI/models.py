...
class AgMachineXUserInput(models.Model):
	...
	category = (('Irrigation Systems','Irrigation Systems'),
	...
	SOIL = (('Soft','Soft'),
            ('Hard','Hard'),
            ('With Stone','With Stone'))
	Budget = (('Below than Rs. 10000', 'Below than Rs. 10000'),
	...
	whatsapp_no= models.CharField(max_length=255, default='')
	...
	crop = models.CharField(max_length=255, null=True, blank=True, choices=CROPS)
	crop_stage = models.CharField(max_length=255, choices=STAGES,null=True, blank=True,)
	machinery_req = models.CharField(max_length=500, choices=category)
	soil_type = models.CharField(max_length=1000, choices=SOIL,null=True, blank=True,)
	...
	current_irrigation_method = models.CharField(max_length=500,choices=IRRITYPE, default='', null=True, blank=True,)
	other_current_irrigation = models.CharField(max_length=500, null=True, blank=True)
	irrigation_req = models.CharField(max_length=500,default='',choices=IRRIREQ,null=True, blank=True,)
	budget = models.CharField(max_length=500, choices=Budget, default='')
	vegetation_type =models.CharField(max_length=500, choices=VEGETATION_TYPE, null=True,blank=True)
...
class CropIntelInput(models.Model):
	...
	Land_Prepration = (('Leveling','Leveling'),
    ...
    # Use itertools.product to generate month-year combinations
	month_year = [(
	...
	land_prepration = models.CharField(max_length=500, choices=Land_Prepration, default='', null=True, blank=True)
...
#AgritechMart: Agritech Mart Introduction
class ATSIntro(models.Model):
	title = models.CharField(max_length=500)
	description = models.TextField()

	class Meta:
		verbose_name = 'Agritech Mart: Enter ATM Introduction'
		verbose_name_plural = 'Agritech Mart: Enter ATM Introduction'

#Agritech Mart: Agritech Mart Product Categories Info       
class ATSInfo(models.Model):
	...
	class Meta:
		verbose_name = 'Agritech Mart: Enter ATM Product Categories Info'
		verbose_name_plural = 'Agritech Mart: Enter ATM Product Categories Info'

#Agritech Mart: Agritech Mart Seller Info
class ATSContactInfo(models.Model):
	...
	class Meta:
		verbose_name = 'Agritech Mart: Enter ATM Supplier Info'
		verbose_name_plural = 'Agritech Mart: Enter ATM Supplier Info'

#Agritech Mart: Supplier/Manufacturer/Seller Product Info
class ATSContactProductInfo(models.Model):
	...
	def __str__(self):
		return f'{self.seller.contact_company_name} - {self.product_name}'

	class Meta:
		verbose_name = 'Agritech Mart: Enter ATM Supplier Product Info'
		verbose_name_plural = 'Agritech Mart: Enter ATM Supplier Product Info'

#This model is inine with ATSContactProductInfo
class ATSContactProductImages(models.Model):
	...
	class Meta:
		verbose_name = 'Agritech Mart: Enter ATM Supplier Product Images'
		verbose_name_plural = 'Agritech Mart: Enter ATM Supplier Product Images'
          
#Agritech Mart: Get Supplier Enquiry to Sell their product in Indian Market
class ATSSeller(models.Model):
	...
	class Meta:
		verbose_name = 'Agritech Mart: Get ATM Seller Enquiry'
		verbose_name_plural = 'Agritech Mart: Get ATM Seller Enquiry'

#This model is inline with ATSSeller
...
class ATSRoadmap(models.Model):
	...
	class Meta:
		verbose_name = 'Agritech Mart: Enter ATM Roadmap Details'
		verbose_name_plural = 'Agritech Mart: Enter ATM Roadmap Details'
...
class Advisor(models.Model):
	...
	whatsapp_no = models.CharField(max_length=10)
	email = models.CharField(max_length=255, null=True, blank=True)
	crop = models.ForeignKey(Crop, on_delete=models.CASCADE, related_name='crops')
	crop_area = models.IntegerField(default=1)
	available_of_str = models.BooleanField(default=True)
	ph_value = models.DecimalField(max_digits=3, decimal_places=1,validators=[MaxValueValidator(14),MinValueValidator(0)],null=True, blank=True)
	n_value = models.FloatField(null=True, blank=True)
	p_value = models.FloatField(null=True, blank=True)
	k_value = models.FloatField(null=True, blank=True)
	nitrogen = models.FloatField(null=True, blank=True, choices=CHOICES)
	phosphorus = models.FloatField(null=True, blank=True, choices=CHOICES)
	potassium = models.FloatField(null=True, blank=True, choices=CHOICES)
	crop_stage = models.CharField(choices=STAGES,null=True,default=None,max_length=255)

	class Meta:
		verbose_name = 'AgriClinic: Get User Enquiry from Nutrient Deficiency Form'
		verbose_name_plural = 'AgriClinic: Get User Enquiry from Nutrient Deficiency Form'
