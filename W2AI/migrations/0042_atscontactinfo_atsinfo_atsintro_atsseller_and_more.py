# Generated by Django 4.2.2 on 2024-04-24 10:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'z1. Enter ATS Supplier Info',
                'verbose_name_plural': 'z1.Enter ATS Supplier Info',
            },
        ),
        migrations.CreateModel(
            name='ATSInfo',
            ...
            options={
                'verbose_name': 'z. Enter ATS Category Info',
                'verbose_name_plural': 'z. Enter ATS Category Info',
            },
        ),
        migrations.CreateModel(
            name='ATSIntro',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'z3. Enter ATS Seller Enquiry',
                'verbose_name_plural': 'z3.Enter ATS Seller Enquiry',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='W2AI.atscontactinfo')),
            ],
            options={
                'verbose_name': 'z2. Enter ATS Supplier Product Info',
                'verbose_name_plural': 'z2.Enter ATS Supplier Product Info',
            },
        ),
        migrations.AddField(
            model_name='atscontactinfo',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='W2AI.atsinfo'),
        ),
    ]
